//// Render many spotlights on an image.
//// This will not compile as it exceeds the maximum parameter space for
//// launching a kernel.
...
//    for (int y = 0; y < 32; y++) {
//      int index = y * 32 + x;
//      lights.lights[index] = {x * spacing, y * spacing, 0.1, 0.5};
//    }
//  }
//
...
//                                        params.height, pitch, 0.3, lights);
//  }
//
